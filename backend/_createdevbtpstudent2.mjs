// One-off: creates a second dev-only BTP student account, fresh (no topic
// requested yet), since dev.student already has an active/completed project.
// Run from backend/ with:  node _createdevbtpstudent2.mjs
...
const EMAIL = "dev.btpstudent2@iiits.in";
const NAME = "Dev BTP Student 2";
const ROLL_NUMBER = "DEVSTU004";
