// One-off: creates a second dev-only Honors student account, fresh (no
// topic requested yet), since dev.honorsstudent already has an active project.
// Run from backend/ with:  node _createdevhonorsstudent2.mjs
...
const EMAIL = "dev.honorsstudent2@iiits.in";
const NAME = "Dev Honors Student 2";
const ROLL_NUMBER = "DEVSTU005";
