...
const data = {
  ...
  project: {
    ...
    about: "It's a backend service that helps to deploy things using Docker, etc.",
    studentbatch: "2022",
    guide: {
      name: "Dr. Asha Iyer",
    ...
    evaluations: [
      ...
      },
      {
        ...
        remark: "Excellent collaboration. More technical details expected in final phase.",
        updates: [
          {
  ...
  const latestEvaluation = data.project.evaluations.find(e => e.time && e.remark);
  const latestRemark = latestEvaluation?.remark || "No Remarks are given yet.";

  const scoreEvaluation = data.project.evaluations.find(e => e.marksgiven !== null && e.marksgiven !== undefined);
  ...
  return (
    <div className="inprogress-dashboard">
      ...
      <div className="secondblock">
        ...
        <RemarksCard remark={latestRemark} />
