...
export default function BTPStudentList({
  bin,
  onSelectStudent,
  selectedStudents,
  available,
      ...
      <div className={classes["student-list-scroll"]}>
        ...
        {filteredStudents.length === 0 ? (
          ...
          filteredStudents.map((student) => {
            const isSelected =
              selectedStudents[parsedBin]?.email === student.email;
            return (
              <div className={classes["student-row"]} key={student.rollno}>
                ...
                <div className={classes["student-details"]}>
                  <div className={classes["student-info"]}>
                    <div className={classes["student-name"]}>
                      {student.name}
                    </div>
                    <div className={classes["student-meta"]}>
                      {student.email}
                    </div>
                  </div>
                  <div className={classes["rollselect"]} >
                    ...
                    <div className={classes["student-actions"]}>
                      <button
                        className={
                          isSelected
                            ? classes["select-button-selected"]
